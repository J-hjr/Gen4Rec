...
class Config:
    ...
    FINETUNED_CKPT = os.path.join(WEIGHTS_DIR, "clap_finetuned_best.pt")
...
def embed_music4all():
    ...
    emb_path = os.path.join(Config.WEIGHTS_DIR, "music4all_embeddings.npy")
...
def main():
    ...
    index_path = os.path.join(Config.WEIGHTS_DIR, "music4all_faiss.index")
